...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"
            include-html="include/sidebar.html">
        </ul>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow"
                    include-html="include/topbar.html">
                </nav>
                <!-- End of Topbar -->
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                當前註冊人數</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">40,510</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                總瀏覽次數</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">1,240,579</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">會員忠誠度
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="dropdown no-arrow">
                                        <button id="downloadDemo1" type="button"
                                            class="btn btn-outline-primary btn-sm active"
                                            style="background-color: #4e73df;"><i class="fa fa-download"></i>
                                            匯出PDF</button>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="dropdown no-arrow">
                                        <button id="downloadDemo2" type="button"
                                        class="btn btn-outline-primary btn-sm active"
                                        style="background-color: #4e73df;"><i class="fa fa-download"></i>
                                        匯出PDF2</button>
                                    </div>
                                    ...
                                    <li>
                                        <div style="display: inline-flex;">
                                            ...
                                            <input type="image" name="submit_Btn" id="submit_Btn" img
                                                src="img/images/放大鏡.png" width="35px">
                                        </div>
                                    </li>
                                </ul>
                                <br>
    ...
    <script src="js/divtopdf.js"></script>
</body>
