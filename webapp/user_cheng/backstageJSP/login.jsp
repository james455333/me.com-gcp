...
<link href="/MountainExploer.com/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
	type="text/css">
<link
...
<body class="bg-gradient-primary">
							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">岳進者</h1>
									</div>
									<form class="user">
									...
									<div class="text-center">
										<a class="small" href="register.html">立即申請帳號</a>
									</div>
								</div>
							</div>
						</div>
	...
	<script src="/MountainExploer.comjs/sb-admin-2.min.js"></script>
